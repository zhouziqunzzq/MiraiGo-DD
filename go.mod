module github.com/zhouziqunzzq/MiraiGo-DD

go 1.15

require (
	github.com/LXY1226/fastrand v0.0.0-20210121160840-7a3db3e79031 // indirect
	github.com/Mrs4s/MiraiGo v0.0.0-20210427120618-fd31a4eb28db
